...
CREATE TABLE "new_Asset" (
    ...
    CONSTRAINT "Asset_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Asset_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_Asset" ("content", "createdAt", "id", "planId", "projectId", "taskId", "title", "updatedAt")
SELECT "content", "createdAt", "id",
       (SELECT "Task"."planId" FROM "Task" WHERE "Task"."id" = "Asset"."taskId"),
       "projectId", "taskId", "title", "updatedAt"
FROM "Asset";
DROP TABLE "Asset";
ALTER TABLE "new_Asset" RENAME TO "Asset";
CREATE INDEX "Asset_projectId_idx" ON "Asset"("projectId");
CREATE INDEX "Asset_planId_idx" ON "Asset"("planId");
...
CREATE TABLE "new_Wireframe" (
    ...
    CONSTRAINT "Wireframe_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Wireframe_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_Wireframe" ("content", "createdAt", "id", "planId", "projectId", "taskId", "title", "updatedAt")
SELECT "content", "createdAt", "id",
       (SELECT "Task"."planId" FROM "Task" WHERE "Task"."id" = "Wireframe"."taskId"),
       "projectId", "taskId", "title", "updatedAt"
FROM "Wireframe";
...
CREATE INDEX "Wireframe_planId_idx" ON "Wireframe"("planId");
...
CREATE TABLE "new_Design" (
    ...
    CONSTRAINT "Design_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO "new_Design" ("assetId", "content", "createdAt", "id", "planId", "projectId", "taskId", "title", "updatedAt", "wireframeId")
SELECT "assetId", "content", "createdAt", "id",
       (SELECT "Task"."planId" FROM "Task" WHERE "Task"."id" = "Design"."taskId"),
       "projectId", "taskId", "title", "updatedAt", "wireframeId"
FROM "Design";
DROP TABLE "Design";
ALTER TABLE "new_Design" RENAME TO "Design";
CREATE INDEX "Design_projectId_idx" ON "Design"("projectId");
CREATE INDEX "Design_planId_idx" ON "Design"("planId");
...
INSERT INTO "new_Review" ("content", "createdAt", "id", "planId", "projectId", "title", "updatedAt")
SELECT "content", "createdAt", "id",
       (SELECT "Plan"."id" FROM "Plan" WHERE "Plan"."projectId" = "Review"."projectId" ORDER BY "Plan"."version" DESC LIMIT 1),
